  ...
  <div class="col-md-12 m-0 p-0" style="font-family:Gilroy">
    ...
    <div class="col-md-10 p-0  " style="margin:0 auto">
        ...
        <div class="col-md-12 m-0 p-0">
          ...
          <div class="tab-content pt-3">
            ...
            <div role="tabpanel" class="tab-pane fade" id="references">
              <div class="col-md-12 col-12 row m-0 p-0">
                <div
                  class="col-md-3 text-center p-3 border col-6"
                  @click="goToType('scooter')"
                >
                ...
                <div
                  class="col-md-3 p-3 text-center border col-6"
                  @click="goToType('bike')"
                >
                  <span class="style-type"
      ...
      <div class="col-md-12 mb-5">
        <div
          class="col-md-10 justify-content-center my-4 row"
          style="margin:0 auto;"
        >
          <div
            style="cursor:pointer"
            class="col-md-4  text-center p-3 border col-4"
